              ...
              >
                ...
                <div className="relative h-64 overflow-hidden cursor-pointer">
                  ...
                  <img
                    ...
                    className="w-full h-full object-cover mix-blend-overlay group-hover:scale-110 transition-transform duration-500 cursor-pointer"
                  />
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 p-2 bg-white/20 hover:bg-white/30 backdrop-blur-md rounded-full transition-all duration-200"
            >
